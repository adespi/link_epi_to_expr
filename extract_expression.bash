...
for list_of_genes in "some_genes" "some_genes_32_Tissue-specific_regulatory_networks_FANTOM5-v1" "all_genes";do #"some_genes_32_Tissue-specific_regulatory_networks_FANTOM5-v1" "all_genes"
